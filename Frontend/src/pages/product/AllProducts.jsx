...
const AllProducts = () => {
  ...
  return (
    <div className="w-full min-h-screen flex justify-start items-center flex-col bg-gray-50 py-8 lg:px-8 xl:px-8 2xl:px-8">
      {/* <NavigationHeader /> */}
      <div className="w-full flex justify-center items-center">
        <div className="lg:w-6/7 xl:w-6/7 2xl:w-6/7 w-full ">
          {/* Header */}
          ...
          {(products || [])?.length === 0 ? (
            ...
            // Product grid
            <div className="  sm:pl-0 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 space-y-6 gap-6">
              {(products || []).map((item) => {
                return (
                  <ProductCard
                    key={item._id}
